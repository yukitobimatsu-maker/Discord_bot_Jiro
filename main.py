...
def generate_ai_message(weather, events):
    ...
    **【本日の天気】**
    * **京都南部の天気:** [ここに現在の天気の箇条書きデータをそのまま、あるいは綺麗に見やすく整理して、ここに記載。この項目はツンデレ口調でなくて良いです。]
    **【本日の予定】**
    [Googleカレンダーの箇条書きデータをそのまま、あるいは綺麗に見やすく整理して、ここに記載。この項目はツンデレ口調でなくて良いです。]
    **【今日の偉人】**
    ...
    3. 最近のタロウの様子の報告：例）「タロウは、教授に似て、全然帰ってこないので、寂しいニャ」「タロウと僕は季節のお魚を食べたい気分だニャ」など
    ...
    chat_completion = client.chat.completions.create(
        ...
        temperature=0.7, # 偉人の選出や呟きのバリエーションを豊かにするため、少し高めに設定
    )
