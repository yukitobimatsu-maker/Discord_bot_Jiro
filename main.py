...
def generate_ai_message(weather, events):
    ...
    **【本日の天気】**
    * **京都南部の天気:** [ここに現在の天気の箇条書きデータをそのまま、あるいは綺麗に見やすく整理して、ここに記載。ジロウのツンデレ口調は封印。]
    **【本日の予定】**
    [Googleカレンダーの箇条書きデータをそのまま、あるいは綺麗に見やすく整理して、ここに記載。ジロウのツンデレ口調は封印。]
    **【今日の偉人】**
    ...
    [その人物の業績と、クスッと笑えるエピソードや人間味のある裏話を、ジロウのツンデレ口調かつ科学オタク知識全開で、3〜4文で紹介してください。]
    ...
    3. 予定の密度を弄る：例）予定がギッシリなら「マルチコピー変異体みたいに過密だね」、スカスカなら「ノックアウト変異体みたいに静かだし、じっくりシーケンスデータでも見たら？」など。
    4. 最近のタロウの様子の報告：例）「タロウは、教授に似て、全然帰ってこないので、寂しいニャ」「タロウと僕は季節のお魚を食べたい気分だニャ」など
    ...
    chat_completion = client.chat.completions.create(
        ...
        temperature=0.8, # 偉人の選出や呟きのバリエーションを豊かにするため、少し高めに設定
    )
